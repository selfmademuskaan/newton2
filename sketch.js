...
function setup() {
	...
	wood = new Wood(245,370,170,10);

	rope1 = new SlingShot (ball1.body,wood.body,-40,0);
	rope2 = new SlingShot (ball2.body,wood.body,-20,0);
	rope3 = new SlingShot (ball3.body,wood.body,0,0);
	rope4 = new SlingShot (ball4.body,wood.body,20,0);
	rope5 = new SlingShot (ball5.body,wood.body,40,0);
